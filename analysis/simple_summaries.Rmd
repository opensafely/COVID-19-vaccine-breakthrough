...
data_processed %>%
  ...
  select(time_to_positive_test, covid_positive_test_date, covid_vax_2_date, censor_date)

length(unique(subset(data_processed, time_to_positive_test < 0))$patient_id)
