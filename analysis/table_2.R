...
results.table[6,2] <- nrow(data %>% filter(region == "London"))
results.table[7,2] <- nrow(data %>% filter(region == "East of England"))
results.table[8,2] <- nrow(data %>% filter(region == "East Midlands"))
results.table[9,2] <- nrow(data %>% filter(region == "North East"))
results.table[10,2] <- nrow(data %>% filter(region == "North West"))
results.table[11,2] <- nrow(data %>% filter(region == "South East"))
results.table[12,2] <- nrow(data %>% filter(region == "South West"))
results.table[13,2] <- nrow(data %>% filter(region == "West Midlands"))
results.table[14,2] <- nrow(data %>% filter(region == "Yorkshire and the Humber"))
...
results.table[6,3] <- nrow(data %>% filter(region == "London"))
results.table[7,3] <- nrow(data %>% filter(region == "East of England"))
results.table[8,3] <- nrow(data %>% filter(region == "East Midlands"))
results.table[9,3] <- nrow(data %>% filter(region == "North East"))
results.table[10,3] <- nrow(data %>% filter(region == "North West"))
results.table[11,3] <- nrow(data %>% filter(region == "South East"))
results.table[12,3] <- nrow(data %>% filter(region == "South West"))
results.table[13,3] <- nrow(data %>% filter(region == "West Midlands"))
results.table[14,3] <- nrow(data %>% filter(region == "Yorkshire and the Humber"))
...
results.table[6,4] <- nrow(data %>% filter(region == "London"))
results.table[7,4] <- nrow(data %>% filter(region == "East of England"))
results.table[8,4] <- nrow(data %>% filter(region == "East Midlands"))
results.table[9,4] <- nrow(data %>% filter(region == "North East"))
results.table[10,4] <- nrow(data %>% filter(region == "North West"))
results.table[11,4] <- nrow(data %>% filter(region == "South East"))
results.table[12,4] <- nrow(data %>% filter(region == "South West"))
results.table[13,4] <- nrow(data %>% filter(region == "West Midlands"))
results.table[14,4] <- nrow(data %>% filter(region == "Yorkshire and the Humber"))
...
results.table[6,5] <- nrow(data %>% filter(region == "London"))
results.table[7,5] <- nrow(data %>% filter(region == "East of England"))
results.table[8,5] <- nrow(data %>% filter(region == "East Midlands"))
results.table[9,5] <- nrow(data %>% filter(region == "North East"))
results.table[10,5] <- nrow(data %>% filter(region == "North West"))
results.table[11,5] <- nrow(data %>% filter(region == "South East"))
results.table[12,5] <- nrow(data %>% filter(region == "South West"))
results.table[13,5] <- nrow(data %>% filter(region == "West Midlands"))
results.table[14,5] <- nrow(data %>% filter(region == "Yorkshire and the Humber"))
...
results.table[6,6] <- nrow(data %>% filter(region == "London"))
results.table[7,6] <- nrow(data %>% filter(region == "East of England"))
results.table[8,6] <- nrow(data %>% filter(region == "East Midlands"))
results.table[9,6] <- nrow(data %>% filter(region == "North East"))
results.table[10,6] <- nrow(data %>% filter(region == "North West"))
results.table[11,6] <- nrow(data %>% filter(region == "South East"))
results.table[12,6] <- nrow(data %>% filter(region == "South West"))
results.table[13,6] <- nrow(data %>% filter(region == "West Midlands"))
results.table[14,6] <- nrow(data %>% filter(region == "Yorkshire and the Humber"))
