...
study = StudyDefinition(
  ...
  covid_vax_1_date = patients.with_vaccination_record(
    ...
    emis = {"procedure_codes": covid_vaccine_chadox,},
    find_first_match_in_period = True,
    between = ["2020-05-14", "2020-11-14"],
  ...
  # second vaccine in trial
  # some participants had a 12 week interval (or longer) and may have been vaccinated after the campaign start
  # here we'll stick to the early participants
  covid_vax_2_date = patients.with_vaccination_record(
    returning = "date",
    tpp = {"product_name_matches": "COVID-19 Vac AstraZeneca (ChAdOx1 S recomb) 5x10000000000 viral particles/0.5ml dose sol for inj MDV",},
    emis = {"procedure_codes": covid_vaccine_chadox,},
    find_first_match_in_period = True,
    between = ["covid_vax_1_date + 14 days", "2020-11-30"],
    date_format = "YYYY-MM-DD",
    return_expectations = {
      "date": {
        "earliest": "2020-06-01",
    ...
    # "A small number of trial participants also received a third dose
    #  of the Oxford Astra-Zeneca vaccine at about 30 weeks after their second dose"
    # Here we'll check for *any* vax record after the second dose
