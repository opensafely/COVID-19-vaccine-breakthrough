...
surv_data_trial <- read_csv(surv_data_trial, here::here("output", "data", "surv_data_trial.csv"))
surv_data_risk_table <- read_csv(surv_data_risk_table, here::here("output", "data", "surv_data_risk_table.csv"))
surv_data_risk_table_trial <- read_csv(surv_data_risk_table_trial, here::here("output", "data", "surv_data_risk_table_trial.csv"))
